...
export default function RegistrationPage() {
    ...
    const validateForm = () => {
        ...
        if (!firstName) {
            newErrors.firstName = "First Name must be provided";
        } else if (firstName.length < 4 || firstName.length > 15) {
            newErrors.firstName = "First name must be 4 to 15 characters long";
        }

        if (!lastName) {
            newErrors.lastName = "Last Name must be provided";
        } else if (lastName.length < 4 || lastName.length > 20) {
            newErrors.lastName = "Last name must be 4 to 20 characters long";
        }
            ...
            <div className="register-form">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="register-button">
                        <button className="rr-button">Create Account</button>
                    </div>
                </form>
